    ...
    <div className="page">
      ...
      <main>
        <section className="hero">
          <div className="hero-text">
            ...
            <div className="hero-actions reveal delay-3">
              <button className="btn outline">View product brief</button>
            </div>
        ...
        <section className="cta">
          ...
          <div className="cta-actions">
            ...
            <button className="btn ghost">Talk to our team</button>
          </div>
        </section>
      </main>
      ...
      <footer className="footer">
        ...
        <div className="footer-social">
          ...
          <a href="https://x.com" className="social-icon" title="X (formerly Twitter)" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.627l-5.1-6.658-5.712 6.658H2.562l7.746-8.973L1.54 2.25h6.798l4.882 6.268L18.244 2.25zM17.474 20.451h1.829L6.75 3.75H4.823l12.651 16.701z" /></svg>
          </a>
        </div>
      </footer>
